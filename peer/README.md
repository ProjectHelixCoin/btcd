...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/projecthelixcoin/btcd/peer)
...
```bash
$ go get -u github.com/projecthelixcoin/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/projecthelixcoin/btcd/peer#example-package--NewOutboundPeer)  
