...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/projecthelixcoin/btcd/integration/rpctest)
...
```bash
$ go get -u github.com/projecthelixcoin/btcd/integration/rpctest
```
